		...
		<div class="container">	
			<div class="content">
				<div class="col-md-6 col-md-offset-1">
					<h1><!-- change this all to PHP-->Slaves of Prostitution: Why Sex Trafficking Should Be Re-Defined</h1> 
					<h5><i><!-- change this all to PHP-->Aug 22, 2014</i></h5>
					<h6><i><!-- change this all to PHP-->By Haley Halverson. Published by </i><a href="http://townhall.com/columnists/haleyhalverson/2014/08/22/slaves-of-prostitution-why-sex-trafficking-should-be-redefined-n1881456/page/full"> Townhall.com</a><i>, 2014.</i></h6>
					<img style="width: 100%;" src="prostitionArticle.jpg"><!-- change this all to PHP-->
                                        <!-- change this all to PHP-->
					<p>In America, humans are for sale.
					<br></br>
					...
					<br></br>
					Complete abolition is the only cure for slavery.</p>				
				</div>
				<div class="col-md-3 col-md-offset-1">
					<div class="articles">
					<br></br> <!--pushes down the links to other blogs so navbar doesn't lay on top-->
						<div class="article-1">	<!-- change this all to PHP-->					
							<a href="sexTrafficking.html"><!-- change this all to PHP-->
							<img style="width: 100%;" src="prostitionArticle.jpg"><!-- change this all to PHP-->
							<h3>Slaves of Prostitution: Why Sex Trafficking Should Be Re-Defined</h3><!-- change this all to PHP-->
							<h6>Aug 22, 2014</h6></a><!-- change this all to PHP-->
							<br></br>
						</div>
						<div class="article-3"><!-- change this all to PHP-->						
							<a href="plannedParenthoodArticle.html"><!-- change this all to PHP-->
							<img style="width: 100%;" src="protestpp.jpeg"><!-- change this all to PHP-->
							<h3>Why Planned Parenthood's Abortion Quotas are Anti-Women</h3><!-- change this all to PHP-->
							<h6>July 3, 2014</h6></a><!-- change this all to PHP-->
							<br></br>
						</div>
						<div class="article-2">						
							<a href="supermanArticle.html"><!-- change this all to PHP-->
							<img style="width: 100%;" src="adoption1.jpg"><!-- change this all to PHP-->
							<h3>Adoption Made Me Love Superman</h3><!-- change this all to PHP-->
							<h6>June 18, 2014</h6></a><!-- change this all to PHP-->
							<br></br>
						</div>												
					</div>
				</div>
